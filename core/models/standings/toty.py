...
class TOTY(AbstractStanding):
    ...
    team = models.ForeignKey(Team, on_delete=models.CASCADE, related_name="toty")
...
class TOTYReaff(models.Model):
    ...
    old_team = models.ForeignKey(
        Team, on_delete=models.CASCADE, related_name="toty_reaff_old"
    )

    new_team = models.ForeignKey(
        Team, on_delete=models.CASCADE, related_name="toty_reaff_new"
    )
