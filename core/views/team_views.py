...
class TeamDetailView(CustomDetailView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        if "all" in self.request.GET:
            tournaments = list({round.tournament for round in rounds})
        ...
        context["totys"] = self.object.toty.order_by("-points", "season")
...
class TeamUpdateView(CustomUpdateView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        context["team_results"] = self.object.team_results.order_by("-tournament__date")

        context["totys"] = self.object.toty.order_by("-season")
