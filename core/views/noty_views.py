...
class NOTYTable(CustomTable):
    ...
    debater = Column(verbose_name='Debater', accessor='debater.name', linkify=lambda record: record.debater.get_absolute_url())
    school = Column(verbose_name='School', accessor='debater.school.name', linkify=lambda record: record.debater.school.get_absolute_url())
